## CUSTOMER OBSESSION
 - ### You used customer feedback to drive improvement
   - Compare tool
 - ### Most difficult customer interaction
   - Compare tool, VRS/ORE/API Integration
 - ### Where you had to balance needs of customer vs business.

## INSIST ON HIGHEST STANDARDS
- ### You were unsatisfied with status quo. How would you change it?
  - For now let's do it
- ### Describe the most significant improvement project you've lead
  - Error repository, Distributed hold and release application
